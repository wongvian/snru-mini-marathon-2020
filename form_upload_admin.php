            ...
            <div class="col-md-12 col-md-offset-3">
                <div class="container">
                    ...
                    <div class="card card-login mx-auto mt-5">
                        <div class="card-header"><h2>Upload หลักฐานการชำระเงิน</h2></div>
                        ...
                        <div class="card-body">
                            <form id="login-form" action="process.php?cmd=cf_slip" method="post"
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                    ใส่เลขบัญชี 4 หลักสุดท้าย(จากบัญชีที่ใช้โอน เพื่อตรวจสอบความถูกต้อง): <?=$slip_acc?> <br>
                                ...
                                <div class="col-md-3 text-center"> <button type="submit" class='btn btn-success btn-lg'>&nbsp;&nbsp;
        การชำระเงินสมบูรณ์ &nbsp;&nbsp;</button> <div>
        <div class="col-md-3 text-center">  <a href="process.php?cmd=re_slip&cit_id=<?=$cit_id?> " class="btn btn-danger btn-lg">ให้ส่งหลักฐานการชำระเงินใหม่</a> <div> 
        <div class="col-md-3 text-center"> <a href="process.php?cmd=reset_slip&cit_id=<?=$cit_id?> " class="btn btn-warning btn-lg">ปรับเป็นรอแจ้งชำระเงิน</a>  <div>
        <!-- <div class="col-md-3 text-center"> <a href="list_regis_admin.php" class="btn btn-danger btn-lg">ยกเลิก</a> <div> -->
</div>
</div>
</div>
</form>
...
<br>
<br>
<div><a href="slip/<?=$file_payment?>"><image width="300" src="slip/<?=$file_payment?>"></image></a></div>
